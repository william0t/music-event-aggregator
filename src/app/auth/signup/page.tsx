    ...
    return (
      <div className="min-h-screen flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-md text-center">
          ...
          <Link href="/auth/login" className="mt-6 inline-block text-brand-500 hover:text-brand-400">
            Back to sign in
          </Link>
        </div>
      </div>
    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-white/50 mt-1">Follow venues and artists, get a weekly newsletter</p>
        </div>

        <div className="bg-surface-800 rounded-2xl p-8 space-y-6 border border-white/5">
          {/* Google OAuth */}
          <Button
            variant="secondary"
            size="lg"
